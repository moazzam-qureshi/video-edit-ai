...
| 11 | Brain context scaling (11.4-min input, projected to 30) | done | **PARTIAL** (cost/parse/scaling PASS at $0.01; edit-type variety FAIL — prompt fragility surfaced) | [`experiments/11_brain_30min/results.md`](../experiments/11_brain_30min/results.md) |
