...
| 11 | Brain context scaling (11.4-min input, multi-pass) | done | **PASS** ($0.011, 221 valid edits, 4 types — needed multi-pass architecture) | [`experiments/11_brain_30min/results.md`](../experiments/11_brain_30min/results.md) |
